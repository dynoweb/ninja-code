...
namespace NinjaTrader.Indicator
{
    ...
    public class TJAUDUSD : Indicator
    {
        #region Variables
		private string i52_AlertSound = "Alert1.wav";
		private string i00_Version = "4/29/14";
		private bool i01_5DigitBroker = true;
		private int i01_EntryOffsetTics = 20;
		private int i02_StopOffsetTics = 70;
		private double i03_Tgt1X = 1.8;
		private double i04_Tgt2X = 5.4;
		private double i05_Tgt3X = 7.3;
		private int i12_SmallTics = 10;
		private int i14_LargeTics = 20;
		private int i21_EMA1Len = 54;
		private int i22_EMA2Len = 54;
		private int i23_JL1Len = 4;
		private int i24_JL2Len = 24;
    ...
    private double IFF(bool test, double trueValue, double falseValue)
    {
      if (test)
		...
		[Description("")]
		[GridCategory("Parameters")]
		private int I01_EntryOffsetTics
		{
		get
		{
		...
		[GridCategory("Parameters")]
		[Description("")]
		private int I02_StopOffsetTics
		{
		get
		{
		...
		[GridCategory("Parameters")]
		[Description("")]
		private bool J21_UseTrailingStop
		{
		get
		{
...
namespace NinjaTrader.Indicator
{
    ...
    {
        private TJAUDUSD[] cacheTJAUDUSD = null;

        private static TJAUDUSD checkTJAUDUSD = new TJAUDUSD();

        /// <summary>
        /// Based on the PTU TrendJumper free calculator for AUDUSD
        /// </summary>
        /// <returns></returns>
        public TJAUDUSD TJAUDUSD(string i00_Version, bool i01_5DigitBroker)
        {
            return TJAUDUSD(Input, i00_Version, i01_5DigitBroker);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public TJAUDUSD TJAUDUSD(Data.IDataSeries input, string i00_Version, bool i01_5DigitBroker)
        {
            if (cacheTJAUDUSD != null)
                for (int idx = 0; idx < cacheTJAUDUSD.Length; idx++)
                    if (cacheTJAUDUSD[idx].I00_Version == i00_Version && cacheTJAUDUSD[idx].I01_5DigitBroker == i01_5DigitBroker && cacheTJAUDUSD[idx].EqualsInput(input))
                        return cacheTJAUDUSD[idx];

            lock (checkTJAUDUSD)
            {
                checkTJAUDUSD.I00_Version = i00_Version;
                i00_Version = checkTJAUDUSD.I00_Version;
                checkTJAUDUSD.I01_5DigitBroker = i01_5DigitBroker;
                i01_5DigitBroker = checkTJAUDUSD.I01_5DigitBroker;
                ...
                TJAUDUSD indicator = new TJAUDUSD();
                ...
                TJAUDUSD[] tmp = new TJAUDUSD[cacheTJAUDUSD == null ? 1 : cacheTJAUDUSD.Length + 1];
                if (cacheTJAUDUSD != null)
                    cacheTJAUDUSD.CopyTo(tmp, 0);
...
namespace NinjaTrader.MarketAnalyzer
{
    public partial class Column : ColumnBase
    {
        ...
        public Indicator.TJAUDUSD TJAUDUSD(string i00_Version, bool i01_5DigitBroker)
        {
            return _indicator.TJAUDUSD(Input, i00_Version, i01_5DigitBroker);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Indicator.TJAUDUSD TJAUDUSD(Data.IDataSeries input, string i00_Version, bool i01_5DigitBroker)
        {
            return _indicator.TJAUDUSD(input, i00_Version, i01_5DigitBroker);
        }
    }
